cordova.define("community-cordova-plugin-consent.Consent", function(require, exports, module) {
'use strict';
...
(function (NativeActions) {
    ...
    NativeActions["showPrivacyOptionsForm"] = "showPrivacyOptionsForm";
    NativeActions["loadAndShowIfRequired"] = "loadAndShowIfRequired";
    NativeActions["privacyOptionsRequirementStatus"] = "privacyOptionsRequirementStatus";
    NativeActions["canRequestAds"] = "canRequestAds";
...
var Consent = /** @class */ (function () {
    ...
    Consent.prototype.canRequestAds = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, execAsync(NativeActions.canRequestAds)];
                    case 1:
                        n = _a.sent();
                        return [2 /*return*/, n];
                }
    ...
    Consent.prototype.loadAndShowIfRequired = function () {
        var n = execAsync(NativeActions.loadAndShowIfRequired);
        return n;
    };
    Consent.prototype.showPrivacyOptionsForm = function () {
        var n = execAsync(NativeActions.showPrivacyOptionsForm);
        return n;
    };
